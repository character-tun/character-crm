...
app.post('/api/detailing-orders', (req, res) => {
  const { client_id, service, status, box, start, end, materials_cost, labor_cost, total, notes } = req.body;
...
app.get('/api/test', (req, res) => {
  res.json({ msg: 'API работает (моковая версия)' });
});
